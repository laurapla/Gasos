...
In conclusion, the Helmholtz-Hodge theorem decomposes the Navier-Stokes equation in two equations that allow the resolution of the pressure field and the velocity field separately.
